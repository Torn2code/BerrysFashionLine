...
const products = [
  {
    id: 1,
    name: "Men Striped Wear",
    description:
      "Black wear with red and white color strip suitable for men wear.",
    image: image1,
    price: 35.99,
  },
  {
    id: 2,
    name: "Rainbow Themed Baby Wear",
    description: "Amazing Rainbow themed baby wear for 1-2yrs old.",
    image: image2,
    price: 25.49,
  },
  {
    id: 3,
    name: "Black Cargo Jacket for Men",
    description: "Black cargo type jacket for men.",
    image: image3,
    price: 55.99,
  },
  {
    id: 4,
    name: "Lady Knee Length Coat",
    description: "Knee length coat for women comes in different sizes.",
    image: image4,
    price: 79.99,
  },
  {
    id: 5,
    name: "Women 2 Piece Wear",
    description: "Crop top jacket and nice fitted trouser.",
    image: image5,
    price: 64.5,
  },
  {
    id: 6,
    name: "Burberry Shirt",
    description: "Full length Burberry shirt for kids.",
    image: image6,
    price: 45.0,
  },
  {
    id: 7,
    name: "Street Style Suit for Ladies",
    description: "Women street style suit.",
    image: image7,
    price: 90.0,
  },
  {
    id: 8,
    name: "FC Cap & Shirt",
    description: "New FC style cap and shirt.",
    image: image8,
    price: 30.0,
  },
  {
    id: 9,
    name: "Buttoned-Neck Shirt",
    description: "Nice buttoned-neck shirt for your kids.",
    image: image9,
    price: 29.99,
  },
  {
    id: 10,
    name: "Floral Girl Coat",
    description: "Floral styled girl clothing comes in different sizes.",
    image: image10,
    price: 70.0,
  },
  {
    id: 11,
    name: "Bridal Ball Gown",
    description: "Bridal Ball Gown clothing comes in different sizes.",
    image: image11,
    price: 70.0,
  },
  {
